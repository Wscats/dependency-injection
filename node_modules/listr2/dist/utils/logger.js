...
class Logger {
    ...
    parseMessage(level, message) {
        let multiLineMessage = message === null || message === void 0 ? void 0 : message.split('\n');
        multiLineMessage = multiLineMessage === null || multiLineMessage === void 0 ? void 0 : multiLineMessage.map((msg) => {
            return this.logColoring({
                level, message: msg
            });
        });
        message = multiLineMessage === null || multiLineMessage === void 0 ? void 0 : multiLineMessage.join('\n');
        return message;
    }
